...
=======
+ I wanted to look at graphics of the ideology trend of cases in the supreme court term of 1976. I used ggplot to create a bar char in coneflower blue. 
...
ggplot(scdb.1976, aes(x = ideology)) + 
  ...
  labs(x = "Ideology", 
       y = "Frequency", 
       title = "Ideology of Court Decisions in 1976")
```

+ That got me wanting to try something different, and look up how to display it in a different color and with percentages instead of volume.
>>>>>>> de66a6b2271956d6170104f318002513436faec5
