...
title: "efleming_hw1"
description: |
  2nd homework assignment (re-upload)
author:
...
require(tidyverse)
library(dplyr)
myDataPath <- read.csv("/Applications/NEW DACSS601 REPO/DACSS601SS22021/_data/covid-responses.tab - covid-responses.tab.csv", header=TRUE) 
